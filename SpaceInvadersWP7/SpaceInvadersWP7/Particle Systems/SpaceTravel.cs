...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    class SpaceTravel : DefaultSprite3DBillboardParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public SpaceTravel(Game cGame) : base(cGame) { }
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
        {
            ...
            Name = "Space Travel Particle System";
        ...
        public void LoadParticleSystem()
        {
            ...
            InitialProperties.LifetimeMax = 12.0f;
            InitialProperties.PositionMin = new Vector3(-11000, 12000, -9000);
            InitialProperties.PositionMax = new Vector3(11000, 12000, 9000);
            InitialProperties.VelocityMin = new Vector3(0, -20000, 0);
            InitialProperties.VelocityMax = new Vector3(0, -20000, 0);
            ...
            InitialProperties.EndWidthMin = mfSizeMin;
            InitialProperties.EndWidthMax = mfSizeMax;
            InitialProperties.EndHeightMin = mfSizeMin;
            InitialProperties.EndHeightMax = mfSizeMax;
            ...
            ParticleSystemEvents.LifetimeData.Lifetime = 0.0f;
